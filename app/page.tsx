...
function FaqPage({onBack,IS_ADMIN,data,onUpdate}){
  const defaultFaqs=[
    ...
    {q:"아직 쇼핑몰 이름(상호)이 없는데 도매에서 물어보면 어쩌죠?",a:"생각해 두었던 상호를 말하면 됩니다. 상호를 들었다고 바로 상호 검색을 하지 않습니다. 아니면 곧 오픈할 거라고 말하고, 촬영 때문에 구매하는 것이라 아직 상호를 생각 안 했다고 해도 됩니다."},
    {q:"도매시장에서 낱장(1장) 구매는 절대 불가능한가요?",a:"전에는 1장 안 된다고 했는데 요즘은 1장도 판매하는 곳들이 많아졌어요."},
    {q:"첫 거래인데 색상별로 1장씩 총 2장 구매하는 건 가능한가요?",a:"네, 가능합니다."},
    {q:"같은 디자인인데 다른 색상 믹스해서 최소 수량 맞출 수 있나요?",a:"컬러별로 다 구매하실 필요 없습니다. 마음에 드시는 컬러만 구매하시면 됩니다."},
    {q:"\"이거 어떻게 나왔어요?\"라는 질문이 정확히 무슨 뜻인가요?",a:"대부분 금액 얘기입니다. 도매 매장에서 \"컬러요? 아니면 금액이요?\"라고 되묻는 경우도 있어요."},
    {q:"도매 매장에서 옷을 직접 입어보거나 대볼 수 있나요?",a:"직접 입어볼 수는 없습니다. 대볼 수는 있지만 매장과 매장 사이가 좁고 사람들의 이동이 많아서 많이 불편하실 거예요."},
    {q:"신상 제품이랑 리오더 제품은 매장에서 어떻게 구분하나요?",a:"정확히 파악하기 힘듭니다. 도매 매장에서 물어봐서 알려주는 것을 믿거나, 신상마켓에서 확인하는 방법밖에 없습니다."},
    {q:"장끼(영수증)를 받을 때 꼭 확인해야 하는 항목이 무엇인가요?",a:"컬러와 장수, 미송이 잡힌 것인지 아닌지, 그리고 금액을 확인하셔야 됩니다."},
    {q:"장끼에 적힌 금액이 맞는지 현장에서 바로 확인해야 하나요?",a:"네, 잘못된 품목을 찍어서 금액이 달라질 수 있으니 확인하셔야 합니다."},
    {q:"수기 장끼랑 프로그램 출력 장끼의 차이점이 있나요?",a:"차이점은 없습니다."},
    {q:"단가를 깎아달라고 네고(흥정)하면 도매에서 싫어하나요?",a:"요즘 신상마켓에 도매 금액이 오픈되어 있어서 금액을 높게 말할 수 없습니다. 옛날처럼 깎아달라고 하시면 안 됩니다."},
    {q:"사입한 물건이 너무 많아서 들고 다니기 힘들 때 어떻게 하나요?",a:"담당 삼촌에게 연락하셔서 문의하시는 게 제일 낫습니다. 전에는 물품 보관소가 있었는데 요즘은 다 없어져서, 친한 매장이 있으면 짐 보관을 요청할 수도 있지만 도매 매장이 좁고 복잡해서 웬만하면 적당히 물건을 하시는 것을 추천드려요."},
    {q:"도매 매장 이모들이 쓰는 '깔'이나 '야마' 같은 은어가 무슨 뜻인가요?",a:"'깔'은 컬러이며, 요즘은 '야마'라는 단어를 잘 쓰지 않습니다."},
    {q:"\"월 밤에 나와요\"라고 하면 언제 물건을 찾으러 가야 하나요?",a:"월요일 밤~화요일 새벽에 물건이 나온다는 말입니다."},
    {q:"도매 매장에 있는 마네킹 코디 그대로 사입해도 괜찮나요?",a:"네, 마네킹 코디 또한 도매 매장에서 신경 써서 한 것이니 그대로 구매하는 것도 옷 코디의 하나의 방법입니다. 추천합니다."},
    {q:"퀄리티 좋은 도매 매장을 구별하는 팁이 있을까요?",a:"상가마다 옷을 보시면 핏과 원단의 차이가 보입니다."},
    {q:"도매 단가가 상가 층수마다 다른 이유가 무엇인가요?",a:"옛날에는 도매 매장마다 판매하는 옷 스타일이 있고, 스타일별로 층수나 상가별로 나누었는데 현재는 구분이 없어졌어요."},
    {q:"사입할 때 제조국(국산/중국산)을 꼭 확인해야 하는 이유가 있나요?",a:"원단의 차이가 많이 나는 경우가 있어요. 판매하시는 단가에 따라 다르겠지만 어느 정도 가격대를 보실 때 원단과 제조국을 꼭 확인하셔야 합니다."},
    {q:"도매 매장 사진 촬영이 금지되어 있는데 제품 기억은 어떻게 하나요?",a:"요즘은 사진 촬영이 다 됩니다. 촬영하시기 전에 찍어도 되는지 매너상 물어보셔야 합니다."},
    {q:"첫 사입 때 몇 개의 매장에서 몇 종류의 옷을 사야 적당한가요?",a:"적당한 기준은 없으며, 마음에 드시는 상품만 하시면 됩니다."},
    {q:"의류 부자재(벨트, 브로치 등)가 포함된 옷은 부자재 누락을 어떻게 확인하나요?",a:"가끔 구매 후 모자라게 들어가는 경우가 있습니다. 물건을 받으신 후 바로 확인하셔야 합니다."},
    {q:"세탁 라벨이나 케어라벨이 안 붙어 있는 도매 옷은 어떻게 처리하나요?",a:"도매 매장에 연락하셔서 물어보시는 것을 추천드립니다."},
    {q:"도매 거래처와 카카오톡 친구를 맺으면 어떤 점이 좋나요?",a:"도매 매장에서 신상이 나올 때 따로 톡을 보내주는 경우가 많고, 이전 대화나 주문 내용이 남아 있어서 샘플 받으실 때 도움이 됩니다."},
    {q:"사입한 영수증(장끼)은 나중에 세금 신고할 때 그대로 쓸 수 있나요?",a:"네, 상품을 구매한 부분이니 도매 매장에서 자료를 받으시고 세액 맞추실 때 사용하시면 됩니다."},
    {q:"도매에서 세금계산서 발행해 달라고 하면 발행 비용을 따로 받나요?",a:"전에는 삼촌들이 자료를 직접 도매 매장에 전달하고 자료 나올 때 대납했으나, 요즘은 카톡으로 받고 온라인 입금하는 방식으로 바뀌었어요."},
    {q:"초보 티 안 나게 자연스럽게 행동하는 꿀팁이 있을까요?",a:"옷을 보면서 \"이거 얼마에 나왔어요? 컬러는요? 원단은요? 반응 어때요?\" 마음에 드는 컬러 주문하시고 상호를 물어보면 대답하시면 됩니다. 처음에는 어색하지만 대부분 초보 티가 나기 때문에 어느 정도 익숙해질 때까지는 초보 티가 납니다. 옛날처럼 무시하거나 불친절하지 않기 때문에 초보 티 내면서 하셔도 됩니다."},
    {q:"도매 매장에 손님이 너무 많을 때는 언제 끼어들어서 주문해야 하나요?",a:"갑자기 몰리는 경우가 있는데 어느 정도 시간이 지나면 빠집니다. 다른 도매 매장 몇 군데 돌아보시고 다시 가시면 됩니다."},
    {q:"물건을 사고 나면 검수는 매장에서 바로 하나요, 집에 가서 하나요?",a:"검수할 수 있는 장소가 없어요. 집이나 사무실에 가셔서 하셔야 합니다. 이상이 있을 시 바로 도매 매장에 연락하셔서 말씀하셔야 합니다. 시일이 지나면 의심받습니다."},
    {q:"도매 매장에서 들고 다니는 큰 봉투(대봉) 묶는 방법이 따로 있나요?",a:"여러 가지입니다. 잘 모르겠다 하시면 지나가는 사입 삼촌한테 알려달라고 하면 친절하게 알려드립니다."},
    {q:"같은 건물 안에서 효율적으로 도는 사입 동선 짜는 법이 궁금합니다.",a:"상가마다 다르지만, 맨 위층에서 천천히 내려오는 것이 편합니다."},
    {q:"도매 사장님이 명함 달라고 하시면 쇼핑몰 명함을 드려야 하나요?",a:"네, 쇼핑몰이나 옷가게(로드샵) 명함이 있으시면 주시면 됩니다."},
    {q:"단골 거래처를 만들면 초보 셀러에게 어떤 혜택이 있나요?",a:"처음 하실 때는 여기저기 하시는 것보다 몇 군데 정하셔서 그 도매 매장만 하시는 것을 추천드립니다. 신상이 나오면 연락이 오고 샘플도 지원해 줍니다."},
  ];
